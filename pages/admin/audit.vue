          ...
          <table class="w-full min-w-[760px] text-right text-sm">
            ...
            <tbody class="divide-y divide-[#e5edf0]">
              <tr v-for="event in events" :key="event.id" class="hover:bg-[#f8fbfc]">
                ...
                <td dir="ltr" class="px-5 py-4 font-mono text-xs text-[#1f7994]">{{ event.action }}</td>
                <td dir="ltr" class="px-5 py-4 font-mono text-xs text-[#61757d]">{{ event.entityType }} · {{ event.entityId }}</td>
