...
.navigation-section { border-top:1px solid #d4e0e4; padding-top:1.25rem; }.navigation-section:first-child { border-top:0; padding-top:0; }.navigation-section-head, .navigation-card-head, .subnavigation-head { display:flex; align-items:center; justify-content:space-between; gap:1rem; }.navigation-section-head h3 { font-weight:700; color:#093544; }.navigation-section-head p, .navigation-empty { margin-top:.25rem; color:#61757d; font-size:.875rem; line-height:1.7; }.navigation-card { margin-top:1rem; border:1px solid #d4e0e4; background:#fafdfe; padding:1rem; }.navigation-card-head { margin-bottom:1rem; color:#093544; font-size:1rem; }.subnavigation { margin-top:1rem; border-top:1px solid #d4e0e4; padding-top:1rem; }.subnavigation-head { color:#24434d; font-size:.9375rem; font-weight:700; }.add, .add-small, .remove { border:1px solid #1f7994; padding:.45rem .7rem; color:#17677f; font-size:.875rem; line-height:1.6; font-weight:700; white-space:nowrap; }.add { background:#eff7f9; }.add-small { padding:.3rem .55rem; }.remove { border-color:#d9a7a7; color:#a32626; }.add:hover, .add-small:hover { background:#dff0f4; }.remove:hover { background:#fff2f2; }
</style>
