    ...
    <div class="container-site py-14 lg:py-16">
      <div class="grid gap-12 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,2fr)]">
        ...
        <div class="space-y-7">
          ...
          <!-- Social icons — Advenica-style circular outline buttons -->
          <div class="flex items-center gap-3 pt-2">
            <a
              ...
              class="flex h-10 w-10 items-center justify-center rounded-full border border-white/20 text-white/50 hover:text-white hover:border-white/40 transition-colors"
            >
